...
id: proof-backfill:networking:02-ip-routing
kind: source-record
module: networking
section: networking
...
current_path: .proof/backfill/sources/networking/02-ip-routing.source-record.md
canonical_path: .proof/backfill/sources/networking/02-ip-routing.source-record.md
...
| PROOF source artifact | `.proof/backfill/sources/networking/proof-source/02-IP-ROUTING.source.md` |
| PROOF table sidecar | `.proof/backfill/sources/networking/proof-source/02-IP-ROUTING.tables.json` |
| PROOF block sidecar | `.proof/backfill/sources/networking/proof-source/02-IP-ROUTING.blocks.json` |
