...
id: proof-backfill:disease:01-bacterial
kind: source-record
module: disease
section: disease
...
current_path: .proof/backfill/sources/disease/01-bacterial.source-record.md
canonical_path: .proof/backfill/sources/disease/01-bacterial.source-record.md
...
| PROOF source artifact | `.proof/backfill/sources/disease/proof-source/01-BACTERIAL.source.md` |
| PROOF table sidecar | `.proof/backfill/sources/disease/proof-source/01-BACTERIAL.tables.json` |
| PROOF block sidecar | `.proof/backfill/sources/disease/proof-source/01-BACTERIAL.blocks.json` |
