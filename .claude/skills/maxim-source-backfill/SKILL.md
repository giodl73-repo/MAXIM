...
description: "Backfill a MAXIM module into PROOF source sidecars, MDCROP views, MDPORT packs, and FLETCH cachelines."
...
PROOF preserves source fidelity and structured sidecars, MDCROP defines views,
...
- Do not hand-edit generated source-corpus outputs unless the task explicitly
  ...
  `.proof/backfill/modules/**`, `.mdcrop/views/**`, `.mdport/packs/**`, and
...
- Keep MDCROP/MDPORT/PROOF interpretation out of FLETCH core; FLETCH only fetches
  and verifies generic cache entries.
- PROOF rendered output should omit frontmatter by default; MDPORT carries
