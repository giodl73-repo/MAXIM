...
proof_original: "06-NETWORK-SECURITY.md"
---
---
...
backsource_ids: [mdloom-backfill:security-engineering:06-network-security, git-history:security-engineering:06-network-security]
