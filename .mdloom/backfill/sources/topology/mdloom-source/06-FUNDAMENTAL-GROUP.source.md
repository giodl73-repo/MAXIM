...
proof_original: "06-FUNDAMENTAL-GROUP.md"
---
---
...
backsource_ids: [mdloom-backfill:topology:06-fundamental-group, git-history:topology:06-fundamental-group]
...
MDLOOM: The universal cover of S¹ is R (unwrap the circle to the real line).
