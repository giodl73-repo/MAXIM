...
proof_original: "04-COMPACTNESS.md"
---
---
...
backsource_ids: [mdloom-backfill:topology:04-compactness, git-history:topology:04-compactness]
...
MDLOOM (requires Axiom of Choice via Zorn's Lemma or ultrafilters):
  Ultrafilter mdloom: An ultrafilter U on ∏Xα determines a point x with xα = lim_U π_α.
