...
backsource_ids: [mdloom-backfill:logic:00-overview, git-history:logic:00-overview]
concepts: [overview]
...
!          !                            !                  !
!          v                            v                  !
!  MDLOOM SYSTEM              TRUTH DEFINITION              !
!  .================.       .==========================.   !
!  ! Axioms         !       ! M != phi                 !   !
...
| 03-MDLOOM-THEORY.md | Natural deduction, sequent calculus | Cut elimination, normalization |
...
| You want to understand proof as a mathematical object (cut elimination, normalization) | Proof theory → 03-MDLOOM-THEORY.md | Curry-Howard: proofs = programs; sequent calculus for meta-proofs |
