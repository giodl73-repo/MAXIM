...
backsource_ids: [mdloom-backfill:logic:09-applications, git-history:logic:09-applications]
...
```
  MDLOOM ASSISTANT    LOGIC BASIS              NOTABLE USES
  ================   ==========               ============
