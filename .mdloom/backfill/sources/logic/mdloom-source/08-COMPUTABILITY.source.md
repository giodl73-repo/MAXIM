...
proof_original: "08-COMPUTABILITY.md"
---
---
...
backsource_ids: [mdloom-backfill:logic:08-computability, git-history:logic:08-computability]
...
```
  ...
  UNDECIDABILITY MDLOOM (Turing 1936):
...
```
  ...
  MDLOOM SKETCH (Reduction from Halting Problem):
