...
proof_original: "03-MDLOOM-THEORY.md"
---
---
...
current_path: logic/03-MDLOOM-THEORY.md
canonical_path: logic/03-MDLOOM-THEORY.md
backsource_ids: [mdloom-backfill:logic:03-proof-theory, git-history:logic:03-proof-theory]
...
```
  MDLOOM THEORY (Natural Deduction)    TYPE THEORY (Lambda Calculus)
  ==================================  ============================
  Formula phi                    <--> Type A
...
```
  MDLOOM-THEORETIC ORDINALS (strength hierarchy):
