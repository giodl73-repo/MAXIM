...
proof_original: "05-MODEL-THEORY.md"
---
---
...
backsource_ids: [mdloom-backfill:logic:05-model-theory, git-history:logic:05-model-theory]
...
```
  ...
  MDLOOM SKETCH (Henkin 1949 method, cleaner than Godel's original):
...
```
  ...
  MDLOOM: Immediate from completeness.
  If T != phi, then T !- phi.
