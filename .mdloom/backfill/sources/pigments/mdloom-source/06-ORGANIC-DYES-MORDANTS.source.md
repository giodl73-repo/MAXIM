...
proof_original: "06-ORGANIC-DYES-MORDANTS.md"
---
---
...
backsource_ids: [mdloom-backfill:pigments:06-organic-dyes-mordants, git-history:pigments:06-organic-dyes-mordants]
...
## Indigo — The Blue That Ran the World
...
```
VAT PROCESS (reduces indigotin to leucoindigo):
  Step 1: REDUCTION
    Add indigo to an alkaline, reducing vat
...
MICROBIOLOGICAL VAT:
  Traditional urine/fermentation vats maintained for months/years
  The microbiome of the vat is the reducing system
  Masters guarded their vat cultures as trade secrets
  Parallel: sourdough starter, but for dyeing
```

### Woad vs Indigo — The Economic Disruption

```
WOAD (Isatis tinctoria):
  European blue dye for ~3,000+ years
  Major industry: France (Toulouse region), Germany (Erfurt, Gotha),
                  England (Somerset, Lincolnshire)
  "Pastel" in French = woad product
  Medieval economy: woad was among the most valuable traded commodities in Europe
...
INDIGOFERA TINCTORIA:
  ...
  Arguments:
  - "Destroys the color faster" (false)
  - "Weakens fibers" (false)
  - "Comes from infidels" (religious/nationalist appeal)
  Germany: banned indigo (1577); lifted 1651
  France: banned indigo (1598); lifted 1737
  England: no effective ban
  The bans delayed but could not prevent the economic disruption
  By 1700: indigo from India/Caribbean had replaced woad everywhere
...
BENGAL INDIGO REVOLT (1859-1860):
  ...
  Gandhi's later mass non-cooperation campaigns drew on similar principles of peasant resistance,
  though direct organizational lineage from the 1859 revolt to the independence movement is debated.
...
CULTIVATION:
  ...
  Major European production: Alsace, Netherlands (Zeeland), Turkey
  Dutch madder (garance) particularly prized for "Turkey Red" quality

TURKEY RED PROCESS (the premium):
  Complex multi-step process developed in India, brought to Marseilles ~1748,
  then UK, Netherlands:
  1. Pre-treat fiber with tannin (oak gall)
  2. Alum mordant
  3. Turkey/olive oil treatment (mordant fixative)
  4. Madder dyebath
  5. Brightening with chalk/tin salt
  Result: brilliant scarlet-red; excellent washfastness
  "Turkey red" = most valued red in 18th-19th century Europe

ALIZARIN SYNTHESIS (1869):
  William Perkin (UK) and Carl Graebe/Carl Liebermann (Germany) simultaneously
  Same month; Graebe + Liebermann's patent filed same day as Perkin's
  (literally the same week in some accounts)
  The first major application of structural chemistry to industrial synthesis
...
COMPARISON TO ALTERNATIVES:
  Weld: steady clear yellow; reasonably lightfast for a flavonoid
  Quercitron bark (see below): more efficient, wider availability
  Modern: synthetic flavone dyes replaced both
```

---

## Mordant Chemistry — The Key to Textile Color
...
## Lake Pigments — Converting Dye to Pigment
...
FUGITIVITY PROBLEM:
  ...
  Vermeer's "Woman in Blue": blue lake areas shifted color
  Constable's landscapes: some pigment areas paler than original
```

---

## Other Historical Dyes
...
| Question | Answer |
|----------|--------|
| Why can't you just dissolve indigo in water and dye cloth? | Indigotin is insoluble. Must reduce to leucoindigo (soluble) → dye fabric → reoxidize to insoluble indigotin inside the fiber |
| Why do woad and tropical indigo produce the same color? | Same molecule: indigotin. Different plants, identical compound. Tropical plant has 10× concentration. |
| What is "saddening" in historical dyeing? | Using iron mordant to darken/cool a color — "sadden" the bright mordant-alum result |
| What is a lake pigment? | Organic dye precipitated onto Al(OH)₃ (or similar) substrate → insoluble colored particle usable in oil/tempera |
| What destroyed the madder industry in 1869? | Simultaneous synthesis of alizarin (madder's active compound) by Perkin and Graebe/Liebermann — immediate price collapse |
| What destroyed the natural indigo industry? | BASF's industrial synthetic indigo (1897, Heumann synthesis) — price dropped 20:1 within a decade |
| What is Turkey Red? | High-quality red using madder + aluminum mordant + oil treatment — developed in India, premium washfast red |
| Why are most lake pigments fugitive? | The organic chromophore (the actual dye molecule) is still present and still absorbs UV → still photodegrades; the alumina substrate doesn't protect it |

---

## Common Confusion Points

**"Vat dye" doesn't mean "dye from a vat":** Vat dye = chemical class of dyes requiring reduction (leucoform) for application. The name comes from the wooden vats used historically. Indigo is a vat dye; so are synthetic indanthrene dyes used in modern denim. The class is defined by the reduction-oxidation dyeing mechanism.

**Denim's indigo is almost entirely synthetic:** Blue jeans use ~22,000 tons/year of synthetic indigotin (same molecule as natural indigo). Natural indigo farming would need millions of acres to meet this demand. The ring-spinning and stonewashing processes are modern; the molecule is ancient.

**"Alum" is not a single compound:** Potash alum (K₂SO₄·Al₂(SO₄)₃·24H₂O) is the common textile mordant. Chrome alum (K₂SO₄·Cr₂(SO₄)₃·24H₂O) is different. Ammonium alum is yet another. Context (textile vs other) usually implies potash alum.

**Fugitive colors in a museum look fine now:** The perceived color state of historical works IS the faded state. We have limited knowledge of original colors in most works without technical analysis. Constable's sketches are significantly paler than originally painted. What you see as "muted, subtle tonality" may be the degraded version of a more vivid original.
