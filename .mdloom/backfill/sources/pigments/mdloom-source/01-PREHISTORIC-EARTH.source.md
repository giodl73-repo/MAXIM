...
proof_original: "01-PREHISTORIC-EARTH.md"
---
---
...
backsource_ids: [mdloom-backfill:pigments:01-prehistoric-earth, git-history:pigments:01-prehistoric-earth]
...
## Blombos Cave — The First Paint Workshop
...
WHY THIS MATTERS:
  ...
  The MIXING of ingredients + intentional recipe = cognitive complexity
  Chemical processing (heat-transforming goethite to hematite) documented
...
## The Iron Oxide Series

### Yellow Ochre → Red: The Transformation
...
HISTORICAL USE:
  Michelangelo's underdrawings (sinopia = red ochre underdrawing)
  Rembrandt's warm underlayers
  Every tradition from Egyptian to Chinese painting
```
...
UMBER (from Umbria, Italy - but found in Cyprus, Turkey, globally):
  ...
  RAW UMBER:
  Green-brown; cooler than sienna; some transparency in oil
...
```
MANGANESE DIOXIDE (pyrolusite, MnO₂):
  Natural black mineral
  Found alongside iron deposits globally
  Lascaux black outlines = manganese dioxide (~17,000 BCE)
  Altamira black = mix of MnO₂ + bone black/charcoal

  Why two black pigments?
  MnO₂: inorganic, mineral black; slightly warmer/brownish
  Carbon: organic black; cooler, more neutral
  Prehistoric artists apparently differentiated them by appearance
  This implies intentional color selection, not random material use

MODERN:
  Industrial: primary ore for manganese metal, batteries (MnO₂ cathode)
  Art: still available as "manganese black"; extremely stable
```
...
BONE BLACK (ivory black):
  Charred bones (now often cow bone; "ivory" from historical tusk use)
  Composition: carbon (~10%) + calcium phosphate (~80%) + calcium carbonate
  Color: blue-black to brownish-black (less dense black than pure carbon)
  BLUE UNDERTONE: the calcium phosphate matrix creates slight blue shift
  Most used black in oil painting historically
  "Ivory black" = original name (best quality from ivory); now always bone
...
PIGMENT APPLICATION TECHNIQUES:
  ...
  |                    | marks in paint             |
  | Blow tubes         | Reeds/bone tubes found;    |
  | (spray painting!)  | spray patterns on walls;  |
  |                    | hand stencils from blowing |
...
MINERAL SOURCES:
  Celadonite: K(Mg,Fe²⁺)(Fe³⁺,Al)[Si₄O₁₀](OH)₂
    Iron-magnesium phyllosilicate; specific deposits in Italy (Verona)
  Glauconite: (K,Na)(Fe³⁺,Al,Mg)₂(Si,Al)₄O₁₀(OH)₂
    Seabed mineral; various deposits including Cyprus, Bohemia

COLOR:
  Muted, cool gray-green (both compounds)
  Low tinting strength (soft color)
  No lightfastness issues (inorganic silicate)
...
MODERN USE:
  Watercolor (warm, muted earth tone)
  Underpainting (same verdaccio principle)
  Industrial: not used
```
...
```
WHY EARTH PIGMENTS SURVIVE MILLENNIA:
...
| Question | Answer |
|----------|--------|
| What mineral is yellow ochre? | Goethite (α-FeOOH) — iron oxyhydroxide |
| What mineral is red ochre? | Hematite (α-Fe₂O₃) — iron oxide |
| How do you make red from yellow ochre? | Heat to ~200°C — dehydration converts goethite to hematite |
| What makes umber dry fast in oil? | Manganese content acts as siccative (oxidative polymerization catalyst) |
| What is bone black's blue undertone from? | Calcium phosphate matrix shifts absorption slightly — more blue reflected than pure carbon |
| Why do cave paintings survive 40,000 years? | Iron oxides are terminal oxidation products — chemically stable, UV-stable, insoluble |
| What was green earth used for? | Byzantine flesh underpainting (verdaccio) — complementary cool base under warm flesh tones |
| Why does ivory black no longer use ivory? | Originally from burned ivory tusks; now always animal bone. Same composition (carbon + calcium phosphate). |

---

## Common Confusion Points

**"Ochre" = any yellow-brown, but chemistry is specific:** In pigment terms, yellow ochre = goethite-dominant; red ochre = hematite-dominant; brown ochre = limonite mix. Casual use of "ochre" to mean any earthy tone is imprecise.

**Sienna and umber are not just "shades of brown":** Chemically distinct. Sienna = high iron, low manganese, warm transparent. Umber = significant manganese dioxide content, fast-drying, cooler. Different handling properties, different roles in painting technique.
