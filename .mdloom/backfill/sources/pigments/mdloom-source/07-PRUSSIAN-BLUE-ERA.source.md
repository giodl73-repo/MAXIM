...
proof_original: "07-PRUSSIAN-BLUE-ERA.md"
---
---
...
backsource_ids: [mdloom-backfill:pigments:07-prussian-blue-era, git-history:pigments:07-prussian-blue-era]
...
THE GREAT WAVE OFF KANAGAWA (Katsushika Hokusai, c. 1831):
  Published in the Thirty-six Views of Mount Fuji woodblock series
  The blue = Prussian blue (introduced to Japan by Dutch traders c. 1820)
  Before Prussian blue: Japanese woodblock printers used costly smalt
  Prussian blue's intensity + affordability = enabled this color saturation
  The most famous image in East Asian art = possible only because of
  an accidental synthesis in Berlin 127 years earlier
...
LEAD CHROMATE: PbCrO₄ (and PbCr₀.₈S₀.₂O₄ = chrome orange)
  ...
  Immediately adopted after commercial availability (~1814)
  Major 19th century yellow pigment
```

### Van Gogh's Darkening Sunflowers

```
VAN GOGH'S SUNFLOWERS (1888):
  Original chrome yellow areas: vivid, brilliant yellow
  Current appearance: dark yellow-brown to greenish-brown in areas
...
GENERAL CHROME YELLOW INSTABILITY:
  All lead chromate pigments susceptible to this photoreduction
  Many 19th century yellow areas in paintings have shifted
  Chrome yellow fell from favor after cadmium yellows became affordable (~1880s)
```

---

## Arsenic Greens — The Killers
...
IMMEDIATE ADOPTION:
  Wallpapers: by 1800, green wallpaper in European homes = Scheele's green
  Textiles: green fabrics dyed with copper arsenite
  Food coloring: added to confections, marzipan, artificial leaves
                 Used to color green peas, pickles, preserved vegetables
  Candles, flowers: artificial colored items
...
### Emerald Green / Paris Green (1814)

```
EMERALD GREEN: copper acetoarsenite, Cu(C₂H₃O₂)₂·3Cu(AsO₂)₂
  Also called: Paris green, Schweinfurt green, Imperial green
...
EVENTUAL BAN:
  US: restricted/banned for most uses by 1947 (agriculture) / ~1980 (all)
  France: prohibited early 20th century
  Modern: banned globally; some vestigial agricultural uses persist
```

---

## Viridian — The Safe Green

```
VIRIDIAN: Cr₂O₃·2H₂O (hydrated chromium(III) oxide)
  Also written: Cr(OH)₃·CrO(OH) or as emerald green's replacement
  ...
  Hydration state determines transparency + color
...
IMPRESSIONIST ADOPTION:
  John Singer Sargent: landscapes (viridian + yellow glazes)
  Claude Monet: lily pond greens
  Camille Pissarro, Paul Cézanne: extensive landscape use
  Cézanne reportedly owned ~40+ tubes of viridian at death
```

---

## Cobalt Blue (1802) and Cerulean Blue (1805)
...
CERULEAN BLUE: CoO·nSnO₂ (cobaltous stannate approximation)
  ...
  Sky-painting choice for outdoor painters
...
| Question | Answer |
|----------|--------|
| What is Prussian blue's color mechanism? | Intervalence charge transfer: Fe²⁺→Fe³⁺ through cyanide bridges — not d-d transition |
| Why does Prussian blue treat nuclear accidents? | Open crystal lattice absorbs Cs⁺ and Tl⁺ by ion exchange — FDA approved for Cs-137 and thallium poisoning |
| Why are Van Gogh's Sunflowers darkening? | Chrome yellow (PbCrO₄) photoreduction: Cr⁶⁺ → Cr³⁺ under UV + sulfur compounds → green/brown products form |
| What is Scheele's green? | Copper arsenite (CuHAsO₃) — brilliant green from 1778, extremely toxic (arsenic), widely used in wallpapers/food |
| What is emerald/Paris green? | Copper acetoarsenite — even more toxic arsenic green, also used as insecticide for Colorado potato beetle |
| What is viridian? | Hydrated chromium(III) oxide — safe, stable, transparent blue-green; replaced arsenic greens |
| What compounds did the coal tar / dye industry spawn? | BASF, Bayer, Hoechst — synthetic dye chemistry scaled to industrial → then pharmaceutical industry |
| What is "The Great Wave"'s blue? | Prussian blue, introduced to Japan via Dutch traders; enabled the characteristic depth of Hokusai's print |

---

## Common Confusion Points

**Chrome yellow is not the same as "chrome" paint:** Chrome yellow = lead chromate (PbCrO₄) — a yellow pigment. "Chrome" metallic finish = physical vapor deposition of chromium metal. No chemical relationship.

**Emerald green as pigment = emerald green as insecticide:** The exact same compound was used in paintings (especially 1840s–1900) and as an agricultural insecticide. Conservation analysis finding "emerald green" in a 19th century painting is also finding an arsenic pesticide. Handling old paintings with emerald green requires precautions.

**Cobalt blue ≠ cobalt blue in pottery:** Cobalt aluminate (CoAl₂O₄) as artist pigment ≠ cobalt-doped glass as Delftware blue. Both contain Co²⁺ as the chromophore; different crystal/glass matrix; different properties. Similar optical effect, different chemistry.

**Van Gogh knew about paint stability:** His letters extensively discuss pigment permanence — he worried about it. He knew chrome yellow was "fugitive" in some sense, but it was the only vivid enough yellow available and synthetic cadmium was not yet affordable at scale. He chose expressiveness over permanence consciously.
