...
backsource_ids: [mdloom-backfill:pigments:00-overview, git-history:pigments:00-overview]
concepts: [overview]
...
## Pigment vs Dye — Fundamental Distinction
...
| Applied externally         |   | Penetrates substrate       |
|                            |   |                            |
| Examples:                  |   | Examples:                  |
| iron oxide (ochre)         |   | indigo (vat dye)           |
...
## How Pigments Produce Color — The Physics

### Mechanism 1: d-d Electron Transitions (Transition Metal Complexes)
...
### Mechanism 3: π→π* Transitions (Organic Chromophores)
...
EXTENDED π CONJUGATION:
  ...
  Rule: RED group of compound = absorbs violet/blue
        ...
        (Absorbed complementary to observed color)
```

### Mechanism 4: Band Gap (Semiconductor Pigments)
...
~5,000 BCE:   Lapis lazuli trade from Badakhshan, Afghanistan
              Used in Egypt, Mesopotamia, Indus Valley

~3,100 BCE:   Egyptian blue (CaCuSi₂O₆)
              FIRST SYNTHETIC PIGMENT manufactured

~1,500 BCE:   Tyrian purple from Murex snails
              Most expensive colorant in antiquity

~400 BCE:     Lead white (cerussite/hydrocerussite) in use
...
1928/1936:    Phthalocyanine blue discovered/developed
              Most lightfast organic blue; now ubiquitous

1958:         Quinacridone pigments (DuPont)
              Stable magentas/violets previously impossible

2000s:        Quantum dot pigments; carbon nanotube blacks (Vantablack)
              Color tuning and near-perfect absorption
```

---

## Binder Chemistry — How Pigment Gets Applied
...
| Question | Answer |
|----------|--------|
| Pigment vs dye — key difference? | Pigment = insoluble particle dispersed in binder. Dye = soluble molecule bonding to substrate. |
| What creates iron oxide's red color? | d-d transition + charge transfer in Fe³⁺ hematite — absorbs blue/green, reflects red |
| Why is lapis lazuli so intensely blue? | S₃⁻ radical anion charge transfer (not d-d) — high extinction coefficient in zeolite-like aluminosilicate framework |
| What's the key parameter for organic pigment color? | HOMO-LUMO gap of the conjugated π system — larger conjugation = smaller gap = longer wavelength absorbed = redder color |
| How do quantum dots produce different colors? | Quantum confinement — band gap increases as nanocrystal shrinks, so smaller = bluer, larger = redder |
| What is a lake pigment? | Organic dye precipitated onto inorganic substrate (Al(OH)₃) to make insoluble colored particle |
| What enabled Impressionism? | Two chemical innovations: tube paint (1841, outdoor portability) + synthetic ultramarine (1826, affordable blue) |
| Why does binder matter for pigment color? | Refractive index match between pigment and binder affects transparency vs opacity; oil shifts apparent color |

---

## Common Confusion Points

**"Pigment" and "dye" are interchanged casually:** Chemistry uses precise definitions. A "food coloring dye" that's actually a lake pigment (precipitated) is technically a pigment, not a dye. The practical difference: dyes penetrate; pigments sit on surface. Fugitivity differs.

**Structural color is not a pigment:** Iridescence in butterfly wings, opal, and soap bubbles comes from thin-film interference or photonic crystal effects — wavelength-selective constructive interference of reflected light. No absorption, no chromophore. Cannot be scraped off as a pigment. The colors shift with angle.

**The same compound can be a dye and a pigment:** Alizarin dissolved in solution = dye. Alizarin precipitated onto Al(OH)₃ = lake pigment (rose madder, alizarin crimson). State of matter changes classification.

**Ancient Greeks painted their marble sculptures:** The "pure white marble" aesthetic of Neoclassicism was built on a misunderstanding — ancient sculptures were painted in vivid colors. UV fluorescence and microsampling reveal pigment traces. The Elgin Marbles had polychrome decoration.
