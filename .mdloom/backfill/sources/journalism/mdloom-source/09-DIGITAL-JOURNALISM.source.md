...
proof_original: "09-DIGITAL-JOURNALISM.md"
---
---
...
backsource_ids: [mdloom-backfill:journalism:09-digital-journalism, git-history:journalism:09-digital-journalism]
...
```
DIGITAL JOURNALISM ECOSYSTEM MAP
==================================

  PRODUCTION               DISTRIBUTION             CONSUMPTION
  ┌────────────────┐       ┌────────────────────┐   ┌────────────────┐
  │  Newsrooms     │       │  Own website/app   │   │  Direct visit  │
  │  (legacy +     │ ────► │  Social platforms  │ → │  Social feed   │
...
```
SEO OPTIMIZATION VS. EDITORIAL JUDGMENT
=========================================
...
## Newsletter Journalism (Substack Model)
...
## Real-Time Verification (OSINT / Bellingcat Methods)

```
OPEN SOURCE INTELLIGENCE FOR JOURNALISTS
==========================================
...
```
ALGORITHM EFFECTS ON JOURNALISM
=================================
...
**Platform reach and journalism reach are not the same thing.** A story with 5 million social media impressions may have had its headline misread by 4.9 million people and its actual content read by 100,000. Impression counts are not reading counts. The conflation of reach with impact overstates digital journalism's effectiveness.

**First-party email lists are the only durable digital asset.** Social media followers, Apple News subscribers, Google News followers — these relationships belong to the platform, not the publisher. The platform can withdraw access unilaterally. An email subscriber list is the publisher's asset. This explains why every serious digital publication pursues email list building relentlessly.

**OSINT is not surveillance journalism.** Using publicly available records to verify claims is standard journalism practice. The Bellingcat methods apply to verifying what sources and images claim — not to surveilling private individuals. The distinction is: using public information to verify news events (legitimate) vs. aggregating public information to track private individuals who are not public figures (ethically problematic and sometimes legally restricted).

**Newsletter economics work at scale but not at commodity.** The Substack model works for writers with established audiences, distinctive voices, and niche expertise. It does not solve the problem of commodity news (what happened today in [your city]). The economics that work for a 10,000-subscriber political newsletter do not translate to replacing a 30-reporter metro newsroom.

**Algorithmic distribution is not neutral.** An algorithm that rewards engagement is making an editorial decision: stories that provoke reaction are amplified; stories that inform without provocation are suppressed. This is editorial judgment embedded in code rather than executed by humans — but it is still editorial judgment with consequences for what the public knows.
