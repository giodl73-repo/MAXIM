...
proof_original: "05-INVESTIGATIVE.md"
---
---
...
backsource_ids: [mdloom-backfill:journalism:05-investigative, git-history:journalism:05-investigative]
...
```
INVESTIGATIVE vs. BEAT JOURNALISM
====================================

  BEAT JOURNALISM:             INVESTIGATIVE JOURNALISM:
  ┌──────────────────────────┐  ┌──────────────────────────────────┐
  │  News drives agenda      │  │  Reporter drives agenda          │
  │  Days to weeks per story │  │  Months to years per project     │
  │  Official sources primary│  │  Documents + sources + data      │
  │  Single reporter usually │  │  Team of reporters often         │
  │  Daily/weekly output     │  │  Single major publication        │
  │  Covers what happened    │  │  Reveals what was hidden         │
  └──────────────────────────┘  └──────────────────────────────────┘
...
## Document-First vs. Source-First Methodology

```
TWO INVESTIGATIVE STARTING POINTS
====================================
...
## FOIA/Records Strategy for Investigation
...
## Computer-Assisted Reporting (CAR) and Data Analysis
...
```
CHRONOLOGY AS INVESTIGATIVE TOOL
===================================
...
The subject interview is the final step before publication. It is not optional.
...
## Legal Exposure: Libel and Related Claims

```
DEFAMATION LAW BASICS (US)
===========================
...
**Investigative journalism is not about opinion — it's about evidence.** The investigative reporter's job is to build an evidentiary record. The evidence speaks; the reporter is the compiler and interpreter, not the judge. Moral outrage about findings is inappropriate in the story (belongs in editorials).

**"On background" is not corroboration.** Two background sources repeating the same claim may both have gotten their information from the same original source — they are not two independent corroborating sources. Independent corroboration requires sources who obtained information independently.

**Confrontation is not ambush journalism.** Giving a subject opportunity to respond is not a "gotcha" tactic. It is a professional obligation and a legal protection. Subjects who refuse to respond are accurately reported as having refused; their refusal is itself often newsworthy.

**Legal review does not guarantee protection.** A story vetted by media lawyers can still be sued. The point of legal review is to reduce avoidable exposure (identifying unverified factual claims, checking attribution of allegations) and prepare for potential litigation, not to eliminate all legal risk.
