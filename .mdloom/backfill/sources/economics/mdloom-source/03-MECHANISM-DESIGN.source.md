...
backsource_ids: [mdloom-backfill:economics:03-mechanism-design, git-history:economics:03-mechanism-design]
...
MDLOOM SKETCH: IIA + Unanimity → some agent is a "pivotal" agent
