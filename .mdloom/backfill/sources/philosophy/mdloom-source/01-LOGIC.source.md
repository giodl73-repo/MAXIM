...
backsource_ids: [mdloom-backfill:philosophy:01-logic, git-history:philosophy:01-logic]
concepts: [logic]
root_concepts: [logic]
...
CURRY-HOWARD ISOMORPHISM:
  ...
  CONSEQUENCES FOR MDLOOM ASSISTANTS:
...
MDLOOM ASSISTANTS vs AUTOMATED PROVERS:
