...
proof_original: "09-MODERN-SYNTHETICS.md"
---
---
...
backsource_ids: [mdloom-backfill:rope-cordage:09-modern-synthetics, git-history:rope-cordage:09-modern-synthetics]
...
High-performance synthetic fibers represent a 10–100× improvement over natural fibers and 5–15× over commodity synthetics. The performance comes from polymer chain orientation: in UHMWPE, crystalline regions of highly oriented molecular chains approach theoretical tensile efficiency. The tradeoffs are UV degradation, thermal sensitivity, or bending fatigue — a different limitation for each fiber family.

```
HIGH-PERFORMANCE FIBER COMPARISON
===================================
  ...
  │  Creep             1.0        1.5    0.6     0.5     0.1     0.3    │
  │  UV stability      1.0        0.8    0.5     0.1     0.5     0.05   │
  │  Heat stability    1.0        0.8    0.2     3.0     1.0     1.5    │
  │  Bending fatigue   1.0        1.2    0.8     0.2     0.6     0.4    │
  │  Cost (relative)   1.0        0.8    8–15    7–12    12–20   25–40  │
  └─────────────────────────────────────────────────────────────────────┘

  VALUES RELATIVE: Polyester = 1.0 in each row.
  Higher = better for all except elongation/creep (lower = better for
  applications needing low stretch).
```
...
### Product Names: Dyneema (DSM/Avient), Spectra (Honeywell)

```
UHMWPE FIBER SCIENCE
======================
  ...
  GRADES (Dyneema):
  SK60:   Original grade; MBS ~2,500 MPa
  SK65:   Improved strength; MBS ~2,800 MPa
  SK75:   High performance; MBS ~3,100 MPa
  SK78:   Enhanced; used in rigging, ropes
  DM20:   Ultra-high modulus (stiffness focus)
...
=================
  ...
  PARA-ARAMID (Kevlar, Twaron, Technora):
  ┌──────────────────────────────────────────────────────────────────┐
  │  Polymer: Poly(p-phenylene terephthalamide) — PPTA               │
  │  Structure: Rigid aromatic rings connected by amide bonds        │
  │    (-CO-NH-) in the chain backbone                               │
  │                                                                  │
...
```
VECTRAN LCP PROPERTIES
=======================

  MANUFACTURER: Kuraray Co. (Japan)
  POLYMER: Poly(hydroxybenzoate-co-hydroxynaphthalate) — thermotropic LCP
...
```
PBO (ZYLON) PROPERTIES
=======================

  MANUFACTURER: Toyobo Co. (Japan) — Brand: Zylon
  FIBER CLASS: Rigid-rod heterocyclic polymer
...
| Application | Best Fiber | Second Choice | Avoid |
|-------------|-----------|---------------|-------|
| Racing yacht standing rigging | Vectran (low creep) | UHMWPE | Aramid (fatigue) |
| Offshore mooring | UHMWPE (floats + strength) | Polyester | PBO (UV) |
| Life safety rescue rope | Polyester | Nylon | UHMWPE (slippery), PBO (UV) |
| Dynamic climbing rope | Nylon | — | UHMWPE, Aramid, PBO |
| Cut-resistant rope cover | Aramid (Kevlar) | UHMWPE | Polyester |
| High-temperature rope | Aramid (Kevlar/Technora) | PBO (if protected) | UHMWPE (<130°C limit) |
| Weight-critical rigging | UHMWPE (strength/weight) | PBO (if sheathed) | Natural fibers |
| Long-term sustained tension | Vectran (ultra-low creep) | UHMWPE | Nylon |
| Throw bag (must float) | UHMWPE or PP | — | Any sinking fiber |

---

## Decision Cheat Sheet

| Performance Requirement | Fiber |
|------------------------|-------|
| Highest strength by weight | UHMWPE (15× steel by weight) |
| Buoyancy + high strength | UHMWPE (only HP fiber that floats) |
| Ultra-low creep, sustained tension | Vectran LCP |
| High temperature (>130°C) | Aramid (Kevlar/Technora) |
| Absolute highest tensile strength | PBO (Zylon) — must be UV-sheathed |
| Best bending fatigue resistance | Polyester (best among comparable) |
| Lowest cost among HP synthetics | Aramid (costs less than Dyneema or Vectran) |
| UV stability without sheath | Polyester (best UV of any synthetic) |

---

## Common Confusion Points

**Dyneema and Spectra are the same polymer, different brands.** Same UHMWPE fiber chemistry. DSM (now Avient) makes Dyneema; Honeywell makes Spectra. Performance is essentially equivalent between similar grades.

**Highest strength fiber (PBO) is also the most dangerous.** PBO's UV degradation is so severe and so invisible that it has caused fatalities. A PBO rope that has been inadvertently exposed to UV looks fine and tests fine on surface inspection but may have lost 60% of its rated strength. Never use PBO without verifiable UV protection history.

**Vectran beats Dyneema specifically for creep, not for strength.** UHMWPE is stronger per unit weight. Vectran is superior specifically where long-duration sustained load would cause creep elongation — yacht rigging tuning, permanent structural cables, long-term tensioned systems.

**"High-strength" fibers fail differently under dynamic loads.** UHMWPE, aramid, and Vectran have low elongation — they store very little energy. A suddenly released high-tension UHMWPE line has almost no rebound (unlike nylon which snaps back). This actually reduces snap-back injury risk compared to nylon mooring lines under sudden failure, but the break itself is fast (small elongation before failure).
