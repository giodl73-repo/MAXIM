...
mdloom_original: "03-PROTOCOLS.md"
---
---
...
HKDF-BASED KEY SCHEDULE (RFC 8446 §7.1):
  ...
  │                    │                                                         │
  │  client_handshake_traffic_secret ← Expand-Label(HS,"c hs traffic", H)        │
  │  server_handshake_traffic_secret ← Expand-Label(HS,"s hs traffic", H)        │
