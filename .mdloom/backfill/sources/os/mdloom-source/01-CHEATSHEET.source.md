...
id: maxim:os:cheatsheet
kind: guide
module: os
section: os
title: Operating Systems - Universal Cheat Sheet and Vocabulary Load-In
status: source-custody
source_custody: partial
current_path: os/01-CHEATSHEET.md
canonical_path: os/01-CHEATSHEET.md
backsource_ids: [mdloom-backfill:os:01-cheatsheet, git-history:os:01-cheatsheet]
concepts: [cheatsheet]
