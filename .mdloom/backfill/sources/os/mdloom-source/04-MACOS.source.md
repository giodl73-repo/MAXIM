...
module: os
section: os
title: macOS Developer Reference
status: source-custody
source_custody: partial
current_path: os/04-MACOS.md
canonical_path: os/04-MACOS.md
backsource_ids: [mdloom-backfill:os:04-macos, git-history:os:04-macos]
concepts: [macos]
root_concepts: [macos]
