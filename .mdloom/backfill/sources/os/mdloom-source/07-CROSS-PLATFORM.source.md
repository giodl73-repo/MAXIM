...
proof_original: "07-CROSS-PLATFORM.md"
---
---
maxim_schema: maxim.frontmatter.v1
id: maxim:os:cross-platform
kind: guide
module: os
section: os
title: Cross-Platform Development Reference
status: source-custody
source_custody: partial
current_path: os/07-CROSS-PLATFORM.md
canonical_path: os/07-CROSS-PLATFORM.md
backsource_ids: [mdloom-backfill:os:07-cross-platform, git-history:os:07-cross-platform]
