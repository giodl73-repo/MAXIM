...
proof_original: "08-AI-ETHICS.md"
---
---
...
backsource_ids: [mdloom-backfill:ethics:08-ai-ethics, git-history:ethics:08-ai-ethics]
concepts: [ai, ethics]
...
IMPOSSIBILITY THEOREM (Chouldechova 2016; Kleinberg et al. 2016):
  ...
  Formal mdloom: when base rates differ (p(Y=1|A) ≠ p(Y=1|B)),
