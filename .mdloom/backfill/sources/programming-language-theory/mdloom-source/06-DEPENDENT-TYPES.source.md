...
title: Dependent Types: Π/Σ Types, MLTT, Coq, Agda, Idris, Lean
status: source-custody
source_custody: partial
current_path: programming-language-theory/06-DEPENDENT-TYPES.md
canonical_path: programming-language-theory/06-DEPENDENT-TYPES.md
backsource_ids: [mdloom-backfill:programming-language-theory:06-dependent-types, git-history:programming-language-theory:06-dependent-types]
...
Edwin Brady's Idris 2 (2020): dependent types designed for verified programming, not just mdloom:
...
MDLOOM ASSISTANTS IN CRYPTOGRAPHY:
