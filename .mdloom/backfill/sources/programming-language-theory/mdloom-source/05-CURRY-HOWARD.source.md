...
title: Curry-Howard Correspondence: Proofs as Programs, Types as Propositions
status: source-custody
source_custody: partial
current_path: programming-language-theory/05-CURRY-HOWARD.md
canonical_path: programming-language-theory/05-CURRY-HOWARD.md
backsource_ids: [mdloom-backfill:programming-language-theory:05-curry-howard, git-history:programming-language-theory:05-curry-howard]
...
```
MDLOOM NORMALIZATION = β-REDUCTION:
...
STRONG NORMALIZATION:
  ...
  THIS IS WHY COQ/AGDA REQUIRE TERMINATION MDLOOMS:
