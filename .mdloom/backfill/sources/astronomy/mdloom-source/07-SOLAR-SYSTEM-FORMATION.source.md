...
proof_original: "07-SOLAR-SYSTEM-FORMATION.md"
---
---
...
backsource_ids: [mdloom-backfill:astronomy:07-solar-system-formation, git-history:astronomy:07-solar-system-formation]
...
### 4.3 Mdport Accretion — The Speed Solution

Classic core accretion (Pollack 1996) was too slow at 5 AU. Mdport accretion (Lambrechts & Johansen 2012) is ~100× faster:
...
```
  ...
  KEY: Mdport accretion explains why Jupiter formed before Saturn (closer,
