...
proof_original: "18-NUMBER-THEORY.md"
---
---
maxim_schema: maxim.frontmatter.v1
id: maxim:mathematics:number-theory
kind: guide
module: mathematics
section: mathematics
title: Number Theory - Complete Reference
status: source-custody
source_custody: partial
current_path: mathematics/18-NUMBER-THEORY.md
canonical_path: mathematics/18-NUMBER-THEORY.md
backsource_ids: [mdloom-backfill:mathematics:18-number-theory, git-history:mathematics:18-number-theory]
...
ZKSNARK MDLOOM SYSTEMS: Groth16, PLONK use pairings for the verification equation.
```
