...
backsource_ids: [mdloom-backfill:abstract-algebra:03-permutation-groups, git-history:abstract-algebra:03-permutation-groups]
...
MDLOOM: Define λ: G → S_G by λ(g) = (x ↦ gx) for each g ∈ G.
