...
backsource_ids: [mdloom-backfill:metalworking:02-casting, git-history:metalworking:02-casting]
concepts: [casting]
...
│   Gas path temp: 1700°C+ (above Ni melting point ~1455°C)      │
