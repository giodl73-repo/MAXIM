...
proof_original: "04-COLOR-PHOTOGRAPHY.md"
---
---
...
backsource_ids: [mdloom-backfill:photography:04-color-photography, git-history:photography:04-color-photography]
...
```
SOFT MDLOOM: simulate on-screen how an image will look when printed
            on a specific printer/paper combination

SOFT MDLOOMING WORKFLOW:
...
PREREQUISITES FOR ACCURATE SOFT MDLOOM:
