...
backsource_ids: [mdloom-backfill:transportation:00-overview, git-history:transportation:00-overview]
concepts: [overview]
...
**EV Charging Infrastructure** (gap note for future expansion): Charging levels (L1: 1.4 kW / L2: 7-19 kW / DC fast: 50-350 kW / HPC: 350+ kW), network topology (home charging handles ~80% of energy; public DC fast for corridors; fleet depot for commercial), standard convergence (CCS1/CCS2 dominant globally; NACS becoming North American standard; CHAdeMO declining outside Japan), grid impact (V2G, managed charging for demand response), and infrastructure planning models are covered in `energy-systems/`. A dedicated file in this directory would complete the transportation electrification picture.
