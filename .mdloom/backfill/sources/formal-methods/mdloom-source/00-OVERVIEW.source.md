...
backsource_ids: [mdloom-backfill:formal-methods:00-overview, git-history:formal-methods:00-overview]
concepts: [overview]
...
|  LINTING        CHECKING        MODEL           PROGRAM      MDLOOM           |
|                                 CHECKING        ANALYSIS                     |
|                                                                              |
...
```
+------------------------+    +------------------------+    +------------------------+
|     SPECIFICATION      |    |     VERIFICATION       |    |        MDLOOM           |
|                        |    |                        |    |                        |
...
Lambda calculus / type theory  MDLOOM ASSISTANTS: Coq's CIC is dependent
