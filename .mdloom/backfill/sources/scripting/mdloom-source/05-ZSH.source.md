...
proof_original: "05-ZSH.md"
---
---
maxim_schema: maxim.frontmatter.v1
id: maxim:scripting:zsh
kind: guide
module: scripting
section: scripting
title: Scripting: Zsh
...
current_path: scripting/05-ZSH.md
canonical_path: scripting/05-ZSH.md
backsource_ids: [mdloom-backfill:scripting:05-zsh, git-history:scripting:05-zsh]
concepts: [zsh]
root_concepts: [zsh]
