...
proof_original: "02-BATCH.md"
---
---
maxim_schema: maxim.frontmatter.v1
id: maxim:scripting:batch
kind: guide
module: scripting
section: scripting
title: Scripting: Batch (CMD)
status: source-custody
source_custody: partial
current_path: scripting/02-BATCH.md
canonical_path: scripting/02-BATCH.md
backsource_ids: [mdloom-backfill:scripting:02-batch, git-history:scripting:02-batch]
concepts: [batch]
root_concepts: [batch]
