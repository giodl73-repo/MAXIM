...
id: mdloom-backfill:history-of-science:04-chemistry-revolution
kind: source-record
...
current_path: .mdloom/backfill/sources/history-of-science/04-chemistry-revolution.source-record.md
canonical_path: .mdloom/backfill/sources/history-of-science/04-chemistry-revolution.source-record.md
...
| MDLOOM source artifact | `.mdloom/backfill/sources/history-of-science/mdloom-source/04-CHEMISTRY-REVOLUTION.source.md` |
| MDLOOM table sidecar | `.mdloom/backfill/sources/history-of-science/mdloom-source/04-CHEMISTRY-REVOLUTION.tables.json` |
| MDLOOM block sidecar | `.mdloom/backfill/sources/history-of-science/mdloom-source/04-CHEMISTRY-REVOLUTION.blocks.json` |
