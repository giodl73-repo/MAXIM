...
backsource_ids: [mdloom-backfill:mathematicians-logicians:00-overview, git-history:mathematicians-logicians:00-overview]
concepts: [overview]
...
What mathematics is about:
  ...
  MDLOOM — which claims are actually true and why, beyond all doubt
