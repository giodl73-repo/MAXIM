...
proof_original: "03-RADEMACHER.md"
---
---
...
backsource_ids: [mdloom-backfill:machine-learning-theory:03-rademacher, git-history:machine-learning-theory:03-rademacher]
concepts: [rademacher]
...
```
MDLOOM SKETCH (one-sided version)
──────────────────────────────────
