...
backsource_ids: [mdloom-backfill:combinatorics:02-binomial-and-identities, git-history:combinatorics:02-binomial-and-identities]
...
```
   ...
   MDLOOM (combinatorial):  expanding the product of n factors (x+y),
...
```
+----------------------------------------------------------------------+
|  IDENTITY            STATEMENT                  MDLOOM IDEA           |
+----------------------------------------------------------------------+
...
```
   ...
   MDLOOM: to choose k people from a room of m women and n men,
...
```
   ...
   MDLOOM: count (k+1)-subsets of {0,1,...,n} by their LARGEST element i.
