...
backsource_ids: [mdloom-backfill:database-systems:00-overview, git-history:database-systems:00-overview]
...
| **CockroachDB** | Mdport (LSM, RocksDB-like) | Serializable via Raft + MVCC | Spanner-inspired, no TrueTime hardware |
