...
proof_original: "09-DISTRIBUTED-SQL.md"
---
---
...
backsource_ids: [mdloom-backfill:database-systems:09-distributed-sql, git-history:database-systems:09-distributed-sql]
...
```
   ...
   - storage engine: MDPORT (an LSM-tree, RocksDB-family) -> guide 01.
...
| **CockroachDB** | Raft per range | Mdport (LSM) | **SERIALIZABLE** | HLC + clock-offset + txn restarts; PG wire |
