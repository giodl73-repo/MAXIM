...
proof_original: "03-SEMICONDUCTORS.md"
---
---
...
backsource_ids: [mdloom-backfill:materials:03-semiconductors, git-history:materials:03-semiconductors]
...
```
    ...
    Record cells (as of 2024 — see NREL Best Research-Cell Efficiency Chart
    at https://www.nrel.gov/pv/cell-efficiency.html for current values):
