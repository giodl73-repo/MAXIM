...
proof_original: "06-CAPSICUM-CHILI.md"
---
---
...
backsource_ids: [mdloom-backfill:spices:06-capsicum-chili, git-history:spices:06-capsicum-chili]
...
|  ✓ Cheap (vs expensive black pepper)                             |
|  ✓ High vitamin C (anti-scurvy bonus)                            |
|  ✓ Shelf-stable when dried                                       |
|  ✓ Spread along Portuguese trade routes globally                 |
+------------------------------------------------------------------+
```

---

## Botany — Five Domesticated Species

*Capsicum* (Solanaceae family — nightshades, related to tomatoes/potatoes):
...
## Domestication and Bird Dispersal

```
CAPSAICIN'S EVOLUTIONARY FUNCTION:
  ...
  +----------------------------+   +----------------------------+
  | BIRDS                      |   | MAMMALS                    |
  | No functional TRPV1        |   | Functional TRPV1           |
  | binding for capsaicin      |   | binding for capsaicin      |
  |                            |   |                            |
  ...
  (term from Paul Rozin, psychologist who studied chili adoption)
```
...
MOLECULAR STRUCTURE:
  ...
  Vanillyl group (aromatic ring portion) = same as in vanillin
  N-vanillyl-8-nonenamide backbone
  The "vanilloid" class definition: compounds with vanillyl pharmacophore
  This is why capsaicin and vanillin share a name root
```
...
HISTORICAL METHOD (Wilbur Scoville, 1912):
  Organoleptic test: panel of 5 trained tasters
  Chili extract diluted until no heat detectable
  Dilution ratio = SHU
  Subjective; inter-panel variation; now obsolete

MODERN METHOD (HPLC):
  High-Performance Liquid Chromatography
  Measure capsaicinoid content directly (mg/g)
  Convert to SHU via standardized factor
  ASTA (American Spice Trade Association) method:
  Capsaicin 1 mg/g = 16,400 SHU
...
## Paprika — Controlled Capsaicin Removal

```
PAPRIKA = Capsicum annuum cultivars bred for:
...
| Question | Answer |
|----------|--------|
| Why don't birds get burned by chilies? | Birds lack the capsaicin binding site on TRPV1 — evolutionary selection for bird-based seed dispersal |
| What's the hottest Capsicum species? | C. chinense (habanero, Carolina Reaper) — routinely 100K–2M+ SHU |
| How do I reduce heat in a dish? | Remove placenta (not just seeds). Add fat/dairy (casein binds capsaicin). Acid helps perception but not the molecule. |
| Why did Scoville's original test fail? | Subjective panel — high inter-rater variability. HPLC replaced it with chemical measurement. |
| What is capsaicin's biosynthetic origin? | Hybrid phenylpropanoid + fatty acid pathway — vanillylamine (from phenylalanine) + branched-chain acid (from valine) |
| What does TRPV1 normally detect? | Temperature >43°C (nociceptive heat). Capsaicin tricks it into firing at room temperature. |
| Why is "mild paprika" the same plant as "habanero"? | Both are Capsicum. Paprika cultivars are bred to have near-zero capsaicin + high carotenoids. Same species, selected for opposite trait. |
| Why did Hungarian cuisine get paprika? | Ottoman expansion into Hungary (16th c.) brought chili via Turkish trade routes from Portuguese-introduced India/ME chilies |

---

## Common Confusion Points

**"C. chinense" does not mean from China:** It's an 18th-century taxonomic error by Nikolaus von Jacquin who thought specimens came from the Caribbean via China. All *C. chinense* varieties are New World (Amazonian South America) in origin.

**Removing seeds doesn't remove most heat:** Placenta (white internal ribs) ≠ seeds. Seeds are adjacent to the placenta and absorb capsaicin. Remove placenta = substantial heat reduction. Removing just seeds = marginal effect.

**"Pepper" for Capsicum:** Columbus called them "pepper" because he was looking for *Piper* (black pepper) and wanted to justify his voyage as finding spices. The name stuck, creating centuries of linguistic confusion. They are unrelated plants.

**Tolerance is real physiology:** TRPV1 desensitizes with repeated stimulation — substance P depletion, receptor downregulation. Regular spicy food consumers genuinely need more capsaicin for the same perception. Not just psychological toughening — actual receptor adaptation.
