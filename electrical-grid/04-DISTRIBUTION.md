...
└───────┬────────────────────────────────────────────────────────────────────┘
   ...
   └────┬────────────────────┬────────────────────┬───────────┘
        │                    │                    │
   ┌────▼───┐          ┌────▼───┐          ┌────▼───┐
   │ Pole TX │          │ Pad TX  │          │ Network │
   │ Single  │          │ 3-phase │          │ vault   │
   │  phase  │          │ 25-500  │          │ TX      │
   │ 5-100   │          │  kVA    │          │ (urban) │
   │  kVA   │          │         │          │         │
   └────┬───┘          └────┬───┘          └────┬───┘
        │                   │                   │
   120/240V              208/480V           120/208V
   Residential          Commercial/Ind.    Dense urban
   single-phase         three-phase        network
```
...
POLE-MOUNTED SINGLE-PHASE (US rural/suburban):
  ┌──────────────┐
  │  [XFMR]     │  ← mounted on distribution pole
  │  25 kVA      │     (5-167 kVA typical range)
  │  7200/120-240│
  └──────┬───────┘
