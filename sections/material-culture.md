...
[`pigments/`](../pigments/00-OVERVIEW.md) → [`coatings/`](../coatings/00-OVERVIEW.md) → [`metalworking/`](../metalworking/00-OVERVIEW.md)
...
[`ceramics/`](../ceramics/00-OVERVIEW.md) → [`glassmaking/`](../glassmaking/00-OVERVIEW.md) → [`metalworking/`](../metalworking/00-OVERVIEW.md)
...
[`pigments/`](../pigments/00-OVERVIEW.md) → [`jewelry/`](../jewelry/00-OVERVIEW.md) → Arts & Culture [`art-history/`](../art-history/00-OVERVIEW.md)
...
| Section | The bridge |
|---------|------------|
| Engineering | [`metalworking/`](../metalworking/00-OVERVIEW.md) is the craft-level version of what Engineering [`mechanical/`](../mechanical/00-OVERVIEW.md) and [`structural/`](../structural/00-OVERVIEW.md) treat analytically — the same steel, different vantage. [`glassmaking/`](../glassmaking/00-OVERVIEW.md) connects to Engineering [`optics/`](../optics/00-OVERVIEW.md) through optical fiber and lens blanks. [`coatings/`](../coatings/00-OVERVIEW.md) connects to [`materials/`](../materials/00-OVERVIEW.md) through tribology, corrosion science, and surface engineering. |
...
| Arts & Culture | [`pigments/`](../pigments/00-OVERVIEW.md) is the material substrate of painting — art history and pigment chemistry are two accounts of the same objects. [`textiles/`](../textiles/00-OVERVIEW.md) feeds directly into fashion and decorative arts traditions in [`art-history/`](../art-history/00-OVERVIEW.md). [`jewelry/`](../jewelry/00-OVERVIEW.md) and [`ceramics/`](../ceramics/00-OVERVIEW.md) are decorative arts categories. |
| Natural World | The chemistry of natural dyes and mordants (textiles) connects to the organic chemistry in [`natural-sciences/`](../natural-sciences/00-OVERVIEW.md). Gemstone formation connects to [`geology/`](../geology/00-OVERVIEW.md) and mineral science. Fiber animals (silk moth, merino sheep) and fiber plants (cotton, flax) connect to [`animal-phylogeny/`](../animal-phylogeny/00-OVERVIEW.md) and [`food-plants/`](../food-plants/00-OVERVIEW.md). |
