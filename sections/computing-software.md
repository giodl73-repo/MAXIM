...
| [`os/`](../os/00-OVERVIEW.md) | Linux/Windows/macOS internals: kernel architecture, process/thread model, virtual memory, file systems, IPC, system calls, scheduling | [`01-LINUX.md`](../os/01-LINUX.md) — Linux kernel model and userland | `computing/` for containers-on-OS; `languages/` for runtime models |
