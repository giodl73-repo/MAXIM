...
Masonry: brick, stone, mortar, structural masonry, arches, vaults, and restoration. Covers unit masonry from historic hand-laying through modern reinforced systems. Connects to construction-materials/ (structural analysis), structural/ (load paths), geology/ (stone types), and rope-cordage/ (pre-industrial building craft).
