...
| Source corpus (regenerated) | `.proof/backfill/**`, `.mdcrop/views/**`, `.mdport/packs/**`, `.fletch/registries/**` for `human-computer-interaction`, `cognitive-science`, `industrial-design` |
...
PROOF/MDCROP/MDPORT/FLETCH from the canonical numbered guides; the two sibling backfills
