...
| **Deferred to Pulse 04** | `00-OVERVIEW` + guides `01`, `04`, `05`, `07`, `08`, `09`, `10`, `11`; `sections/*`; `.mkdocs/mkdocs.yml`; `TRACKER.md`; reciprocal pointers into `industrial-design/05`, `cognitive-science/09`, `human-computer-interaction/`; source-corpus (`.proof/backfill/**`, `.crop/**`, `.pebble/**`, `.fletch/**`) |
