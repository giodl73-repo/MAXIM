...
| Source corpus (regenerated) | `.proof/backfill/**`, `.crop/views/**`, `.pebble/packs/**`, `.fletch/registries/**` for `human-factors` + the 5 changed content-guide siblings |
...
The source-corpus backfill regenerates PROOF/CROP/PEBBLE/FLETCH from the canonical numbered
