...
| Source corpus | `.proof/backfill/sources/chemistry/**`, `.proof/backfill/modules/chemistry.json`, `.mdcrop/views/**`, `.mdport/packs/**`, `.fletch/registries/maxim-chemistry-source-corpus.json` |
