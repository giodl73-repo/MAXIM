...
| **Deferred to Pulse 04** | `00-OVERVIEW` + guides 01, 02, 04, 05, 06, 07, 09, 10, 11; `sections/life-sciences.md`; `.mkdocs/mkdocs.yml`; `TRACKER.md`; source-corpus (`.proof/backfill/**`, `.crop/**`, `.pebble/**`, `.fletch/**`) |
...
- Do not run full module source backfill (PROOF/CROP/PEBBLE/FLETCH) — this is a
