...
| **Completed 2026-07-12 (was "Deferred post-sign-off")** | `00-OVERVIEW` + guides 01–07, 09, 11 authored; reciprocal `clinical-medicine/03`→`pathology/` and `medicine/10`→`pathology/08` cross-references added (plus `disease/00`→`01`–`03`, `disease/04`→`05`/`10`); `sections/life-sciences.md`, `.mkdocs/mkdocs.yml`, `TRACKER.md` wired; source-corpus regenerated (`.proof/backfill/**`, `.mdcrop/**`, `.mdport/**`, `.fletch/**`) |
